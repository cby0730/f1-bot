 ...
 * The stock glyph sits high-right in the square; the group nudge optically
 * centers it (padding-equalized on a 56px render).
 */
export const TelegramIcon: React.FC<{
  readonly size?: number;
  readonly glyphOpacity?: number;
}> = ({ size = 32, glyphOpacity = 1 }) => {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <g opacity={glyphOpacity} transform="translate(-1.93 1.07)">
        <path
          fill="#ffffff"
